...
(define (make-level-1)
  (let ([track (make-track surf:grass)]
        ...
        [sand2 (make-segment surf:sand 200)]
    ...
    (add-segment-point! road (vec2 1700 300))
    (add-segment-point! road (vec2 2100 -100))
    (add-segment-point! road (vec2 2500 -200))
    (add-segment-point! road (vec2 2700 -300))
    ...
    (add-segment-point! sand2 (vec2 -100 -300))
    (add-segment-point! sand2 (vec2 0 -300))
    (add-segment-point! sand2 (vec2 400 -400))
    (add-segment-point! sand2 (vec2 1500 -500))
    (add-segment-point! sand2 (vec2 2000 -400))
    (add-segment-point! sand2 (vec2 2500 -800))
    (add-segment-point! sand2 (vec2 2000 -800))
    (add-track-segment! track sand2)
